...
import nz.co.spark.springrestsecurity.error.BookNotFoundException;
import nz.co.spark.springrestsecurity.error.BookUnSupportedFieldPatchException;
...
public class BookController {
    ...
    Book newBook(@Valid @RequestBody final Book newBook) {
        ...
        return repository.findById(id)
                .map(x -> {
                    ...
                    if (!StringUtils.isEmpty(author)) {
                        ...
                        // better create a custom method to update a value = :newValue where id =
                        // :id
                        return repository.save(x);
                    } else {
