...
public class StudentControllerTest {
	...
	public void retrieveDetailsForCourse() throws Exception {
		...
		Mockito.when(
				this.studentService.retrieveCourse(Matchers.anyString(), Matchers
						.anyString()))
				.thenReturn(this.mockCourse);
	...
	public void createStudentCourse() throws Exception {
		...
		final RequestBuilder requestBuilder = MockMvcRequestBuilders.post(
				...
				.accept(MediaType.APPLICATION_JSON).content(this.exampleCourseJson)
